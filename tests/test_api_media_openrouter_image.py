...
def test_resolve_openrouter_image_key():
    ...
    info = svc.resolve_workflow("api/openrouter/x-ai/grok-imagine-image-quality")
    assert info["provider"] == "openrouter"
    assert info["model"] == "x-ai/grok-imagine-image-quality"
...
async def test_dispatch_openrouter_image(tmp_path):
    ...
    with patch("pixelle_video.services.api_media.OpenRouterImageClient") as Cli:
        ...
        res = await svc(prompt="hi", workflow="api/openrouter/x-ai/grok-imagine-image-quality",
